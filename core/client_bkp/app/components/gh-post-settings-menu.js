...
export default Component.extend(SettingsMenuMixin, {
    ...
    actions: {
        ...
        toggleIsEvent() {
            let post = this.post;
            post.set('isEvent', !post.isEvent);
            return this.savePost.perform();
            // this.toggleProperty('post.isEvent');

            // console.log(this.get('post.isEvent'));
        ...
        setEventDate(date) {
            let post = this.post;
            let dateString = moment(date).format('YYYY-MM-DD');
            post.get('errors').remove('eventDate');
            post.set('eventDate', dateString);
            return this.savePost.perform();
        },

        setEventLocation(eventLocation) {
            let post = this.post;
            post.set('eventLocation', eventLocation);
            return this.savePost.perform();
        },
