...
export default BaseValidator.create({
    ...
    eventDate(model) {
        if (model.isEvent && !model.eventDate) {
            model.errors.add('eventDate', 'Event Date is required.');
            this.invalidate();
        }
    },

    eventLocation(model) {
        if (model.isEvent && !model.eventLocation) {
            model.errors.add('eventLocation', 'Event Location is required.');
            this.invalidate();
        }
    },
